...
summary: Trident ofrece a los usuarios de Kubernetes la capacidad de expandir sus volúmenes una vez que se crean. Encuentre información sobre las configuraciones que se necesitan para ampliar los volúmenes iSCSI y NFS. 
---
...
[role="lead"]
Trident ofrece a los usuarios de Kubernetes la capacidad de expandir sus volúmenes una vez que se crean. Encuentre información sobre las configuraciones que se necesitan para ampliar los volúmenes iSCSI y NFS.
