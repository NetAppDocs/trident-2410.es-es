...
TIP: Para obtener más información sobre la arquitectura de Astra Trident en el clúster de Kubernetes, consulta link:../trident-get-started/intro.html#astra-trident-architecture["Arquitectura Astra Trident"].
