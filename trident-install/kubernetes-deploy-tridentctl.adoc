...
[%collapsible]
====
Para obtener más información sobre «force detach», consulta link:..trident-install/kubernetes-customize-deploy.html["Personalice la instalación del operador de Trident"].
