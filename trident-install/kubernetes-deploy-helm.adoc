...
----
. Utilice `helm install` y especifique un nombre para la implementación como en el siguiente ejemplo, donde `100.2410.0` se encuentra la versión de Trident que está instalando.
+
[listing]
----
