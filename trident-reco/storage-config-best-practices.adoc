...
Para obtener más información acerca de los grupos de políticas de QoS, consulte https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-cmpr-980/TOC__qos.html["Comandos de calidad de servicio de ONTAP 9.8"^] .
...
* http://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sanag/home.html["Guía de administración de los sistemas SAN"^] (Para iSCSI)
