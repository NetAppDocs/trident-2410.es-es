...
summary: Puede utilizar el comando protectctl para crear e interactuar con recursos personalizados de Trident Protect. 
---
...
--
.Pasos
. Descargue el complemento CLI de Trident Protect:
+
[source, console]
----
