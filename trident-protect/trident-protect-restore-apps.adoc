...
NOTE: Si el AppVault CR no existe en el clúster de destino, créalo siguiendo los pasos en link:trident-protect-appvault-custom-resources.html["Utilice objetos Trident Protect AppVault para administrar depósitos"].
